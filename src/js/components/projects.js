...
const featuredProjectsDB = [
    ...
    // },
    {
        id: "telecom",
        label: "Telecom",
        icon: "src/assets/icons/telecom.svg",
        // PROJECT DETAILS
        ...
        technologies: [
            { icon: "src/assets/icons/nextjs.svg", color: "#DD0031" },
            { icon: "src/assets/icons/django.svg", color: "#68A063" },
            { icon: "src/assets/icons/mongodb.svg", color: "#555" },
            { icon: "src/assets/icons/linux.svg", color: "#8D7646" }
        ],
        testimonial: {
    ...
    // },
    {
        ...
        technologies: [
            { icon: "src/assets/icons/bulma.svg", color: "#4caf50" },
            { icon: "src/assets/icons/python.svg", color: "#3776AB" },
            { icon: "src/assets/icons/react.svg", color: "#333" },
            { icon: "src/assets/icons/tailwindcss.svg", color: "#FBBF24" }
        ],
        testimonial: {
        ...
        images: {
            // Energy placeholders
            desktopBack: "src/assets/projects/rashalweb1.png",
            desktopFront: "src/assets/projects/rashalweb2.png",
            mobileLeft: "src/assets/projects/rashalphone1.png",
            mobileRight: "src/assets/projects/rashalphone2.png"
        },
